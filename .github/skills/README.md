...
|---|---|---|
| [`build-and-verify-docs`](./build-and-verify-docs/SKILL.md) | Canonical preview and verification process: type checks, clean build, affected-page inspection, offline links, and a structural consistency pass. | Building, previewing, or verifying the site; before every commit/PR. |
